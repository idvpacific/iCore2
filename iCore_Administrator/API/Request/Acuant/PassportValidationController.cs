...
{
    [Route("api/Request/Passport-Validation")]
    public class PassportValidationController : ApiController
    {
        //=========================================================================================================================================
        ...
        public async Task<API_Main_Result> PostAsync()
        {
            ...
            string API_Name = "Passport-Validation";
            string API_Code = "4";
            string API_FullName = "Acuant Passport Validation";
            bool Tran_Add = false;
            //---------------------------------------------------------------------------------------------------------------------------------------------------------
                                ...
                                if (ID_Front_Name != "")
                                {
                                    ...
                                    if ((FIFormat == "jpg") || (FIFormat == "jpeg") || (FIFormat == "png") || (FIFormat == "gif"))
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            FunctionResult_Mesaage.Error = true;
                                            FunctionResult_Mesaage.Description = "Back image file format not valid, Authorized formats : JPG ,JPEG ,PNG, GIF";
                                        }
                                    }
                                    else
                                    {
                                        ...
                                        FunctionResult_Mesaage.Error = true;
                                        FunctionResult_Mesaage.Description = "Front image file format not valid, Authorized formats : JPG ,JPEG ,PNG, GIF";
                                    }
                                }
                                else
                                {
                                    ...
                                    FunctionResult_Mesaage.Error = true;
                                    FunctionResult_Mesaage.Description = "Front image not founded, Please reviewing your request structure";
                                }
                            }
                            else
                            {
