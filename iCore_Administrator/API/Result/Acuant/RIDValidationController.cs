...
{
    [Route("api/Result/ID-Validation")]
    public class RIDValidationController : ApiController
    {
        //=========================================================================================================================================
        ...
        public API_Main_Result Get()
        {
            ...
            string API_Name = "ID-Validation";
            string API_Code = "2";
            string API_FullName = "Acuant ID Card Validation";
            //---------------------------------------------------------------------------------------------------------------------------------------------------------
