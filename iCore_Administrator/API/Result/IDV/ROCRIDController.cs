...
{
    [Route("api/Result/OCR-ID")]
    public class ROCRIDController : ApiController
    {
        //=========================================================================================================================================
        ...
        public API_Main_Result Get()
        {
            ...
            string API_Name = "OCR-ID";
            string API_Code = "7";
            string API_FullName = "IDV Driving Licence Card OCR And Classification";
            //---------------------------------------------------------------------------------------------------------------------------------------------------------
