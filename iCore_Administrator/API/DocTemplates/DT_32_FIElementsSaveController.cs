            ...
            try
            {
                ...
                if (DT.Rows != null)
                {
                    if (DT.Rows.Count == 1)
                    {
                        if (DelData == 1)
                        {
                            SQ.Execute_TSql(DataBase_Selector.Administrator, "Delete From Template_08_FrontImage_Elements Where (CID = '" + DBI.CountryID + "') And (SID = '" + DBI.StateID + "') And (DTID = '" + DBI.DocumentTypeID + "') And (DID = '" + DBI.DocumentID + "')");
                            LastRes = "OK";
                        }
                        else
                        {
                            ...
                            if (H_raw != "")
                            {
                                ...
                                SQ.Execute_TSql(DataBase_Selector.Administrator, "Insert Into Template_08_FrontImage_Elements Values ('" + DBI.CountryID + "','" + DBI.StateID + "','" + DBI.DocumentTypeID + "','" + DBI.DocumentID + "','" + FIE.V1 + "','" + FIE.V2 + "','" + FIE.V3 + "','" + FIE.V4 + "','" + FIE.V5 + "','" + FIE.V6 + "','" + FIE.V7 + "','" + FIE.V8 + "','" + FIE.V9 + "','" + FIE.V10 + "','" + FIE.V11 + "','" + FIE.V12 + "','" + FIE.V13 + "','" + FIE.V14 + "','" + FIE.V15 + "','" + FIE.V16 + "','" + FIE.V17 + "')");
                                LastRes = "OK";
                            }
                            else
                            {
